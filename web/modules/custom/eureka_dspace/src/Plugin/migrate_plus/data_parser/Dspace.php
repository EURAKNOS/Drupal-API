...
namespace Drupal\eureka_dspace\Plugin\migrate_plus\data_parser;

use Drupal\Core\Plugin\ContainerFactoryPluginInterface;
use Drupal\migrate_plus\DataParserPluginBase;

/**
 * Obtain DSpace data for migration.
 *
 * @DataParser(
 *   id = "dspace",
 *   title = @Translation("DSpace")
 * )
 */
class Dspace extends DataParserPluginBase implements ContainerFactoryPluginInterface {
  ...
  protected function getSourceData($url) {
    /** @var \Drupal\eureka_dspace\DspaceService $token */
    $token = \Drupal::service('eureka_dspace.service.dspace')->authenticate();
    ...
    try {
      ...
      $source_data = json_decode($body, TRUE);
